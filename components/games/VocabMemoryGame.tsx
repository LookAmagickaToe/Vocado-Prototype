    ...
    <>
      <div className="grid grid-cols-12 gap-4 items-start">
        ...
        <div className="col-span-12 md:col-span-7">
          <div
            className="bg-[#FAF7F2] backdrop-blur rounded-2xl p-2 sm:p-4 shadow-sm border border-[#3A3A3A]/5"
            onClickCapture={(e) => {
        ...
        <aside className="col-span-12 md:col-span-5">
          <div className="rounded-2xl border border-[#3A3A3A]/5 bg-[#FAF7F2] p-4 backdrop-blur">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium text-[#3A3A3A]">{rightTitle}</div>
            ...
            {carouselPair ? (
              ...
              <div className="mt-3 text-xs text-[#3A3A3A]/50">
                {emptyHint}
              </div>
            )}
          </div>
        ...
        {showWinOverlay && (
          <WinningScreen
            ...
            onRestart={() => {
              ...
              setIsWon(false)
              setSlots(prev => prev.map((s, i) => ({ ...s, assigned: null })))
              setUrn(shuffle(baseDeck))
              setSeenSlots(new Set())
              setFlippedKeys([])
              setMatchedPairIds(new Set())
