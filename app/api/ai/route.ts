...
function buildParsePrompt({
  ...
  return [
    ...
    "For verbs, provide an optional 'conjugation' object with this shape: {\"verb\":\"...\",\"translation\":\"...\",\"sections\":[{\"title\":\"Präsens\",\"rows\":[[\"ich\",\"...\"],[\"du\",\"...\"],[\"er/sie/es\",\"...\"],[\"wir\",\"...\"],[\"ihr\",\"...\"],[\"sie/Sie\",\"...\"]]}]}. Include Simple Present, Simple Past, and Present Perfect.",
...
function buildNewsPrompt({
  ...
  return [
    ...
    "For verbs, provide an optional 'conjugation' object with the same shape as in buildParsePrompt.",
