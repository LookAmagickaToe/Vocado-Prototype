...
export function buildNewsPrompt({
  ...
  return [
    ...
    "CRITICAL: Pronouns (rows[i][0]) MUST be in the TARGET language (e.g. 'yo', 'tú' for Spanish, 'ich', 'du' for German). Do NOT use source language pronouns.",
    "summary: 3-7 sentences forming a single flowing mini-article in the TARGET language. If the input is already in the target language, summarize it in the SAME language.",
