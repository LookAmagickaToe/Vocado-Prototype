...
function buildParsePrompt({
  ...
  return [
    ...
    "For verbs, you MUST provide a 'conjugation' object. It MUST have exactly 3 sections with titles 'Präsens', 'Präteritum', and 'Perfekt'.",
    "Structure: {\"verb\":\"...\",\"translation\":\"...\",\"sections\":[{\"title\":\"Präsens\",\"rows\":[[\"ich\",\"...\"],...]},{\"title\":\"Präteritum\",\"rows\":[...] },{\"title\":\"Perfekt\",\"rows\":[...]}]}.",
...
export function buildNewsPrompt({
  ...
  return [
    ...
    "title: The title of the article, translated into the TARGET language.",
    "For verbs, you MUST provide a 'conjugation' object with exactly 3 sections: 'Präsens', 'Präteritum', 'Perfekt'.",
    "Conjugation Structure: {\"infinitive\":\"...\",\"translation\":\"...\",\"sections\":[{\"title\":\"Präsens\",\"rows\":[[\"ich\",\"...\"],...]},{\"title\":\"Präteritum\",\"rows\":[...] },{\"title\":\"Perfekt\",\"rows\":[...]}]}.",
